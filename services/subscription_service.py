...
class SubscriptionService:
    ...
    def format_subscription_response(self, subscription_result: Dict) -> Dict:
        ...
        if subscription_type == "test_user" and subscription_result["is_pro"]:
            return {
                "status": "TEST USER",
                "message": "User is a test user with premium access",
                "expiry_date": None,  # Test users have no expiry
                "dreams_remaining": None,  # Test users have unlimited dreams
                "is_pro": subscription_result["is_pro"],
                "response": subscription_result
            }
        elif subscription_type == "pro_subscription" and subscription_result["is_pro"]:
            return {
                "status": "Pro",
